...
`;
    ...
    function modNewDesign() {
         ...
         */
        const OBR_STRETNUTIA = 'data:image/svg+xml;base64,';
        const OBR_PRESTAVKA = 'data:image/svg+xml;base64,';
        const OBR_CAKANIE = 'data:image/svg+xml;base64,';
 ...
 */
body.${BODY_CLASS} #Main--PersonalStatus_FlexBox .statusBtn[data-pda-obraz] {
  position:relative !important; overflow:hidden !important; }
body.${BODY_CLASS} #Main--PersonalStatus_FlexBox .statusBtn[data-pda-obraz]::after {
...
body.${BODY_CLASS} #Main--PersonalStatus_FlexBox .statusBtn[data-pda-obraz="stretnutia"]::after {
  background-image:url(${OBR_STRETNUTIA}); }
body.${BODY_CLASS} #Main--PersonalStatus_FlexBox .statusBtn[data-pda-obraz="prestavka"]::after {
  background-image:url(${OBR_PRESTAVKA}); }
body.${BODY_CLASS} #Main--PersonalStatus_FlexBox .statusBtn[data-pda-obraz="cakanie"]::after {
  background-image:url(${OBR_CAKANIE}); }
...
`;
        ...
        function obrazkyStavov() {
            const box = document.getElementById('Main--PersonalStatus_FlexBox');
            if (!box) return;
            box.querySelectorAll('.statusBtn').forEach((b) => {
                const t = (b.textContent || '').trim().toLowerCase()
                    .normalize('NFD').replace(/[̀-ͯ]/g, '');
                let znacka = '';
                if (/^stretnut/.test(t)) znacka = 'stretnutia';
                else if (/^prestav/.test(t)) znacka = 'prestavka';
                else if (/^cakan/.test(t)) znacka = 'cakanie';
                if (znacka && b.dataset.pdaObraz !== znacka) b.dataset.pdaObraz = znacka;
            });
        }
